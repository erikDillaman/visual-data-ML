...
const DATASETS = [
  {
    ...
    exploreFile: 'explore_fantasy.js',
  },

  {
    id:          'characters',
    name:        'Character Alignment',
    description: 'Meet Heroes, Villains, and wanderers — then train an AI to tell friend from foe!',
    emoji:       '⚔️',
    tagline:     '40 characters · 5 features',
    dataFile:    'data2.js',
    testFile:    'test_data2.js',
    exploreFile: 'explore_characters.js',
  },
