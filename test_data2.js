...
const TEST_ITEMS = [
  { id: 301, name: "Village Priest",   type: "Human",     disposition: "Calm",       strength: 1,  territory: "Village", speaks: true,  alignment: "Friend"  },
  { id: 302, name: "Skeletal Warrior", type: "Undead",    disposition: "Curious",    strength: 5,  territory: "Dungeon", speaks: false, alignment: "Foe"     },
  { id: 303, name: "Baby Slime",       type: "Beast",     disposition: "Curious",    strength: 2,  territory: "Dungeon", speaks: false, alignment: "Friend"  },
  { id: 304, name: "Thunder Bird",     type: "Beast",     disposition: "Aggressive", strength: 7,  territory: "Forest",  speaks: false, alignment: "Friend"  },
  { id: 305, name: "Magma Crab",       type: "Beast",     disposition: "Menacing",   strength: 5,  territory: "Volcano", speaks: false, alignment: "Neutral" },
  { id: 306, name: "Ruins Scholar",    type: "Human",     disposition: "Curious",    strength: 4,  territory: "Ruins",   speaks: true,  alignment: "Neutral" },
  { id: 307, name: "Wind Elemental",   type: "Elemental", disposition: "Wary",       strength: 8,  territory: "Forest",  speaks: false, alignment: "Foe"     },
  { id: 308, name: "Spirit Dancer",    type: "Spirit",    disposition: "Calm",       strength: 5,  territory: "Village", speaks: true,  alignment: "Neutral" },
  { id: 309, name: "Forest Witch",     type: "Human",     disposition: "Wary",       strength: 4,  territory: "Forest",  speaks: true,  alignment: "Foe"     },
  { id: 310, name: "Plague Zombie",    type: "Undead",    disposition: "Aggressive", strength: 3,  territory: "Dungeon", speaks: false, alignment: "Foe"     },
];
